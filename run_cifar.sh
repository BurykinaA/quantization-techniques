...
python quant_resnet.py --dataset cifar --quant_type qat --bitwidth 8 --epochs 50
python quant_resnet.py --dataset cifar --quant_type qat --bitwidth 6 --epochs 50
python quant_resnet.py --dataset cifar --quant_type qat --bitwidth 4 --epochs 50
