...
\begin{frame}{Digital Quantisation}
  ...
  \begin{tikzpicture}[
    ...
    \node[histbox] (hwb) at (3.0, 3.0) {\includegraphics[width=2.6cm]{figs/dist_w_hat.pdf}};
    ...
    \node[histbox] (hxb) at (3.0,-3.0) {\includegraphics[width=2.6cm]{figs/dist_x_hat.pdf}};
    \draw[link] (hx.north)  -- (Z1.south -| hx);
    \draw[link] (hxb.north) -- (Z1.south -| hxb);

    \node[histbox] (hy) at (6.3, 3.0) {\includegraphics[width=2.6cm]{figs/dist_y.pdf}};
