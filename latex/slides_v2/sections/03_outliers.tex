...
\begin{frame}{Digital Quantisation}
  ...
  \begin{tikzpicture}[
    ...
    \node[histbox] (hwb) at (4.6, 3.0) {\includegraphics[width=2.6cm]{figs/dist_w_hat.pdf}};
    ...
    \node[histbox] (hxb) at (4.6,-3.0) {\includegraphics[width=2.6cm]{figs/dist_x_hat.pdf}};
    \draw[link] (hx.north)  -- (Z1.south -| hx);
    \draw[link] (hxb.north) -- (Z1.south -| hxb);

    \node[histbox] (hy) at (9.4, 3.0) {\includegraphics[width=2.6cm]{figs/dist_y.pdf}};
