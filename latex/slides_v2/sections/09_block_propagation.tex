...
\begin{frame}{Block-wise Calibration (FlatQuant Baseline)}
...
\begin{frame}{Our Extension I: Cross-block Propagation}
  ...
  \begin{columns}[T]
    \begin{column}{0.32\textwidth}
      \vspace{1.5em}
      \footnotesize
      \emph{Departure from FlatQuant.} Input to block $\ell$ is the
      \alert{ADC-quantised output of block $\ell{-}1$}, not the clean
      FP input.\\[0.5em]
