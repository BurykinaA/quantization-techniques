...
# Configuration
QAT_CHECKPOINT="./ADC/bert_my/checkpoints/outputs_qat/checkpoint-1000"  # Change this to your QAT checkpoint
OUTPUT_DIR="./ADC/bert_my/outputs_adc_ptq"
...
# Build the command
CMD="python ADC/bert_my/bert_adc_ptq.py \
