...
from ADC.models import resnet18_cifar, resnet18_cifar_adc # Assuming MLP is not part of this specific experiment comparison
...
def run_experiment():
    ...
    print("\n--- Experiment with ResNet18 (ADC) ---")
    model_r18_adc = resnet18_cifar_adc(10)
